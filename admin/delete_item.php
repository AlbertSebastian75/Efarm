...
<!--Search End-->
  ...
  <form method="post" action="delete_item_connection.php">
      <center><br><br><br>
                ITEM ID:<input type="text" class="b2" name="items_id" autofocus required readonly value=<?php echo $items_id; ?>><br><br><br><br>
                <b class="d1"> Are you sure to delete the item?  </b><br><br>
